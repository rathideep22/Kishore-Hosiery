...
const styles = StyleSheet.create({
  ...
  partyName: { fontSize: FontSize.sm, fontWeight: '600', color: Colors.text, marginBottom: 1 },
  locationText: { fontSize: FontSize.xs, color: Colors.info, fontWeight: '500', marginBottom: 2 },
  ...
  backButtonEmptyText: { fontSize: FontSize.sm, fontWeight: '700', color: '#fff' },
  ...
  backBtnText: { fontSize: FontSize.xs, fontWeight: '700', color: Colors.brand },
  ...
  dispatchBtnText: { fontSize: FontSize.xs, fontWeight: '700', color: '#fff' },
  ...
  modalTitle: { fontSize: FontSize.md, fontWeight: '800', color: Colors.text, marginBottom: Spacing.xs, textAlign: 'center' },
});
