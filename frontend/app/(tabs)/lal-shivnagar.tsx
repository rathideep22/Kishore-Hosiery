    ...
    <SafeAreaView style={styles.safe}>
      <View style={styles.header}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push('/dispatch?godown=Lal-Shivnagar')}
          activeOpacity={0.7}
        >
...
const styles = StyleSheet.create({
  ...
  locationBadge: { fontSize: FontSize.xs, color: Colors.info, fontWeight: '600', backgroundColor: Colors.info + '15', paddingHorizontal: Spacing.xs, paddingVertical: 2, borderRadius: 4, overflow: 'hidden' },
