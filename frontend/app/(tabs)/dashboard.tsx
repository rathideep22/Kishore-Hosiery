...
const styles = StyleSheet.create({
  ...
  userName: { fontSize: FontSize.lg, fontWeight: '800', color: Colors.text, marginTop: 2, numberOfLines: 1 },
  ...
  statLabel: { fontSize: FontSize.xs, color: Colors.textSecondary, marginTop: 3, lineHeight: 12, numberOfLines: 2 },
  ...
  allOrdersLabel: { fontSize: FontSize.xs, color: Colors.brand, fontWeight: '700', marginTop: 0, lineHeight: 12, numberOfLines: 1 },
  ...
  orderId: { fontSize: FontSize.sm, fontWeight: '700', color: Colors.brand, numberOfLines: 1 },
  partyName: { fontSize: FontSize.sm, color: Colors.text, fontWeight: '500', marginTop: 2, numberOfLines: 1 },
  locationText: { fontSize: FontSize.xs, color: Colors.textSecondary, marginTop: 1, numberOfLines: 1 },
