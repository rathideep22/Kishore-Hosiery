...
const styles = StyleSheet.create({
  ...
  headerRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: Spacing.md, paddingTop: Spacing.md, paddingBottom: Spacing.sm, gap: Spacing.sm },
  title: { fontSize: FontSize.lg, fontWeight: '800', color: Colors.text, flex: 1, numberOfLines: 1 },
  markAll: { fontSize: FontSize.xs, color: Colors.info, fontWeight: '600', numberOfLines: 1 },
  list: { paddingHorizontal: Spacing.md, paddingBottom: Spacing.xl, gap: Spacing.xs },
  card: { flexDirection: 'row', alignItems: 'center', backgroundColor: Colors.surface, borderWidth: 1, borderColor: Colors.border, borderRadius: 8, paddingHorizontal: Spacing.sm, paddingVertical: Spacing.sm, marginBottom: 0, gap: Spacing.sm },
  cardUnread: { backgroundColor: Colors.info + '08', borderColor: Colors.info + '30' },
  iconWrap: { width: 40, height: 40, borderRadius: 20, justifyContent: 'center', alignItems: 'center', flexShrink: 0, minHeight: 40, minWidth: 40 },
  cardContent: { flex: 1, marginLeft: 0, minWidth: 0 },
  message: { fontSize: FontSize.sm, color: Colors.textSecondary, numberOfLines: 2 },
  messageUnread: { color: Colors.text, fontWeight: '600' },
  time: { fontSize: FontSize.xs, color: Colors.textSecondary, marginTop: 2, numberOfLines: 1 },
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: Colors.info, flexShrink: 0 },
